...
//ToDo: BLEScannerにしてみる。

public class BeaconService3 extends Service implements BootstrapNotifier {
    ...
    private BeaconService3 context;
    ...
    public void onCreate() {
        ...
        // NUTに対応させる！
        String IBEACON_FORMAT = "m:2-3=0603,i:4-19,i:20-21,i:22-23,p:24-24";
        //mBeaconManager.getBeaconParsers().add(new BeaconParser().setBeaconLayout(IBEACON_FORMAT));
        //mBeaconManager.getBeaconParsers().add(new BeaconParser().setBeaconLayout(""));
